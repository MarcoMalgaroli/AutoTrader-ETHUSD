...
def main():
    ...
    #     threshold=_TR_CFG["threshold"], model_type="lstm"
    # )

    # # --- MLP Backtest ---
    # res_mlp, trades_mlp = backtest_triple_barrier.backtest_triple_barrier(
    #     df, backtest_window, predict_window, initial_capital, lookahead, atr_mult,
    #     threshold=_TR_CFG["threshold"], model_type="mlp"
    # )
    ...
    # print(f"Lookahead: {_TR_CFG['lookahead']}")
    # print(f"ATR Multiplier: {_TR_CFG['atr_mult']}")
